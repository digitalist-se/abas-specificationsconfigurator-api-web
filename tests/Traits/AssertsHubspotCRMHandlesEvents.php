...
trait AssertsHubspotCRMHandlesEvents
{
    protected function assertHubspotCRMServiceHandlesUserRegistered(MockInterface $crmService, array $userAttributes): void
    {
    ...
    protected function assertHubspotCRMServiceHandlesExportedDocument(MockInterface $crmService, User $user): void
    {
        $crmService
            ->shouldReceive('upsertContact')
